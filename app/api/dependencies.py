...
def get_tokenizer() -> Tokenizer:
    ...
    if os.path.exists(settings.VOCAB_PATH):
        ...
        print(
            f"Warning: Vocab file not found at {settings.VOCAB_PATH}. Tokenizer is uninitialized."
        )
    return tokenizer
...
def get_model() -> MiniGPT:
    ...
    if os.path.exists(settings.MODEL_PATH):
        ...
        print(
            f"Warning: Model checkpoint not found at {settings.MODEL_PATH}. Model is uninitialized."
        )
